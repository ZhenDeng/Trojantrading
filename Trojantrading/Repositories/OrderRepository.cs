    ...
    public class OrderRepository : IOrderRepository
    {
        ...
        public ApiResponse AddOrder(ShoppingCart cart, double gst, double priceExclGst, double discount)
        {
            try
            {
                ...
                stringBuilder.Append("<h3 style='margin:15px 20px 10px 20px;font-size:1.1em;color:#454545;text-align:center'>Order #" + orderId + " for Customer " + currentUser.Account + "</h3>");
                stringBuilder.Append("</td></tr>");
                ...
                stringBuilder.Append("<td style='padding:1em 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong style ='font-size:10px'>Original Price ex.GST</strong></td>");
                ...
                stringBuilder.Append("<tr><td colspan='1'>&nbsp;</td><td colspan='3' width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4'>Total Price Excl.GST</td>");
                ...
                stringBuilder.Append("<tr><td colspan='1'>&nbsp;</td><td colspan='3' width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4'>Total Price Inc.GST</td>");
