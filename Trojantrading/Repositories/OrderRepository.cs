...
namespace Trojantrading.Repositories
{
    ...
    {
        ApiResponse AddOrder(ShoppingCart cart, int gst, int priceExclGst, int discount);
        Order Get(int id);
    ...
    public class OrderRepository : IOrderRepository
    {
        ...
        public ApiResponse AddOrder(ShoppingCart cart, int gst, int priceExclGst, int discount)
        {
            try
            {
                ...
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'>&nbsp;</td></tr>");
                ...
                stringBuilder.Append("<img src ='https://ci6.googleusercontent.com/proxy/Gunm1Ui60tevgKhW_lccMS_unKUUgy-lJMieq_PRab1QyTLnRoP9G1x6zOVZC4jdRT5fDUVlNj_RpRc=s0-d-e1-ft#https://st-group.net.au/img/stg-logo.png' width='80px' style='margin:0 auto;display:block'>");
                ...
                stringBuilder.Append("<tr><td width='600' style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'>");
                ...
                stringBuilder.Append("<tbody><tr><td align='center' style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'>&nbsp;</td></tr>");
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'>");
                ...
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'><table width='90%' cellspacing='0' cellpadding='0' align='center' bgcolor='#ffffff' border='0'>");
                ...
                foreach (var item in cart.ShoppingItems)
                {
                    ...
                    stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><p style='font:12px;font-family=Arial,Helvetica,sans-serif;margin:0 0 0 0'>$" + item.Product.OriginalPrice + "</p></td>");
                    if (currentUser.Role.ToLower() == "agent")
                    {
                        stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong>$" + item.Product.AgentPrice + "</strong></td>");
                    }
                    else if (currentUser.Role.ToLower() == "wholesaler")
                    {
                        stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong>$" + item.Product.WholesalerPrice + "</strong></td>");
                    }
                    stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:center'>" + item.Amount + "</td>");
                    if (currentUser.Role.ToLower() == "agent")
                    {
                        stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><span><strong>$" + item.Product.AgentPrice * item.Amount + "</strong></span></td></tr>");
                    }
                    else if (currentUser.Role.ToLower() == "wholesaler")
                    {
                        stringBuilder.Append("<td style='padding:0 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><span><strong>$" + item.Product.WholesalerPrice * item.Amount + "</strong></span></td></tr>");
                    }
                }
                stringBuilder.Append("</tbody>");
                ...
                stringBuilder.Append("<td width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong>$<span>" + priceExclGst + "</span></strong></td></tr>");
                ...
                stringBuilder.Append("<td width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong>$<span>" + gst + "</span></strong></td></tr>");
                ...
                stringBuilder.Append("<td width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong>$<span>" + priceIncGst + "</span></strong></td></tr>");
                ...
                stringBuilder.Append("<td width='100' style='padding:0.5em 0.25em;border-bottom:1px solid #c4c4c4;text-align:right'><strong><span>" + discount + "</span></strong></td></tr>");
                stringBuilder.Append("</tfoot></table></td></tr>");
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'><table width='90%'><tbody>");
                stringBuilder.Append("<tr><td valign='top' width='50%' style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'><h3 style='margin:15px 20px 10px 20px;font-size:1.1em;color:#454545;text-align:left'>Shipping Address</h3>");
                stringBuilder.Append("<p style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545;margin:12px 20px 10px 20px;margin-bottom:0'>" + currentUser.Account + "<br>" + currentUser.ShippingCustomerName + "<br>");
                ...
                stringBuilder.Append("<td valign='top' width='50%' style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'><h3 style='margin:15px 20px 10px 20px;font-size:1.1em;color:#454545;text-align:left'>Billing Address</h3>");
                stringBuilder.Append("<p style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545;margin:12px 20px 10px 20px;margin-bottom:0'>" + currentUser.Account + "<br>" + currentUser.BillingCustomerName + "<br>");
                ...
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545'>&nbsp;</td></tr>");
                stringBuilder.Append("<tr><td style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#454545;background:#f6f4ef;text-align:center;border-bottom:1px solid #d3d3d3'><p style='font:12px;font-family=Arial,Helvetica,sans-serif;color:#45659d;margin:12px 20px 10px 20px;text-decoration:none'><a href='https://st-group.net.au' style='color:#454545;text-decoration:none' target='_blank'><strong>https://st-group.net.au</strong></a></p></td></tr>");
